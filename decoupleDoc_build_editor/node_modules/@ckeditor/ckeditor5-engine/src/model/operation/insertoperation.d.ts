...
import NodeList from '@ckeditor/ckeditor5-engine/src/model/nodelist';
import { type NodeSet } from '@ckeditor/ckeditor5-engine/src/model/operation/utils';
import type { Selectable } from '@ckeditor/ckeditor5-engine/src/model/selection';
