 ...
 */
import ViewConsumable from '@ckeditor/ckeditor5-engine/src/conversion/viewconsumable';
...
import type ViewDocumentFragment from '@ckeditor/ckeditor5-engine/src/view/documentfragment';
import type ModelDocumentFragment from '@ckeditor/ckeditor5-engine/src/model/documentfragment';
import type { default as Schema, SchemaContextDefinition } from '@ckeditor/ckeditor5-engine/src/model/schema';
import type ModelWriter from '@ckeditor/ckeditor5-engine/src/model/writer';
import type ViewItem from '@ckeditor/ckeditor5-engine/src/view/item';
