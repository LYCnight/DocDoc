...
-------------------- write_without_dep for 'Mesopotamia' --------------------
...
-------------------- write_without_dep for 'Indus Valley Civilization' --------------------
...
-------------------- write_without_dep for 'Ancient Rome' --------------------
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Ancient Rome`.
A: 
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Persian Empire`.
A: 
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Early Middle Ages`.
A: 
...
-------------------- write_without_dep for 'Late Middle Ages' --------------------
...
<last_heading>
last contents item: `High Middle Ages`
text:
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Late Middle Ages`.
A: 

-------------------- write_without_dep for 'Renaissance' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Renaissance` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Renaissance and Reformation`
text:
None
</last_heading>
<retrieved_knowledge>
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Renaissance`.
A: 

-------------------- write_without_dep for 'Reformation' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Reformation` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Renaissance`
text:
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Reformation`.
A: 

-------------------- write_without_dep for 'Scientific Revolution' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Scientific Revolution` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Reformation`
text:
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Scientific Revolution`.
A: 

-------------------- write_without_dep for 'Industrial Revolution' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Industrial Revolution` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Industrial Revolution`.
A: 

-------------------- write_without_dep for 'World Wars' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `World Wars` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Industrial Revolution`
text:
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `World Wars`.
A: 

-------------------- write_without_dep for 'Cold War and Beyond' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Cold War and Beyond` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<task>
Q: Based on the content, digest, last_heading, and retrieved_knowledge, generate the body content for the table of contents item `Cold War and Beyond`.
A: 
...
<rule>
You are writing the body content of the table of contents item `Conclusion` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Cold War and Beyond`
text:
**Cold War and Beyond**
...
-------------------- write_mutation for 'Ancient Civilizations' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Ancient Civilizations` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<dep_text>
1.Mesopotamia: [Mesopotamia, known as the "Cradle of Civilization," is one of the earliest regions where human societies began to form complex and organized states. Located in the fertile valleys between the Tigris and Euphrates rivers, Mesopotamia hosted several influential cultures and empires that significantly impacted the course of history.
...
2.Ancient Egypt: [Ancient Egypt is one of the most iconic and fascinating civilizations in world history, known for its monumental architecture, advances in various fields, and rich cultural heritage. Situated along the fertile banks of the Nile River, Ancient Egypt developed a unique and enduring civilization that has captivated historians and the public alike.
...
3.Indus Valley Civilization: [Indus Valley Civilization
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Ancient Civilizations`.
A: 

-------------------- write_mutation for 'Classical Antiquity' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Classical Antiquity` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Indus Valley Civilization`
text:
...
<dep_text>
1.Ancient Greece: [Ancient Greece is a cornerstone of Western civilization, known for its profound contributions to philosophy, politics, art, and science. Spanning from the archaic period through the Hellenistic era, Ancient Greece's legacy continues to influence contemporary society.
...
2.Ancient Rome: [Ancient Rome is one of the most influential civilizations in world history, known for its remarkable contributions to law, politics, engineering, and culture. From its legendary founding to the fall of the Western Roman Empire, Ancient Rome's legacy continues to shape our modern world.
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Classical Antiquity`.
A: 

-------------------- write_mutation for 'Middle Ages' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Middle Ages` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
**Classical Antiquity** marks a period of exceptional cultural, political, and intellectual achievements, primarily centered around Ancient Greece, Ancient Rome, and the Persian Empire. Spanning from the 8th century BCE to the 6th century CE, this era laid the foundational pillars of Western civilization, influencing art, philosophy, science, and governance.

- **Geographic and Environmental Context**: The diverse regions across the Mediterranean, Middle East, and parts of Europe played a crucial role. Fertile plains, rugged mountains, and strategic coastlines shaped the development and interactions of these civilizations.
  - **Ancient Greece**: Located in southeastern Europe, comprising the mainland and numerous islands. The mountainous terrain led to the rise of independent city-states.
  - **Ancient Rome**: Centered on the Italian Peninsula, with its strategic position in the Mediterranean aiding trade and military expeditions.
  - **Persian Empire**: Originated in modern-day Iran, expanding across Asia, Africa, and Europe, with varied landscapes influencing its vast expanse.

- **Ancient Greece**: Known for contributions to philosophy, politics, and science. Key periods include the Archaic, Classical, and Hellenistic eras, each marked by significant developments in culture, governance, and military innovations.
  - **Political Structures**: Diverse forms of government, including monarchies, oligarchies, and democracies, with Athens pioneering direct democracy.
  - **Culture and Society**: Notable advancements in philosophy, art, and architecture, with a strong emphasis on proportion and beauty. Religion played a central role, with a rich pantheon of gods and myths.
  - **Military Innovations**: Development of the phalanx formation and significant naval power.

- **Ancient Rome**: Renowned for its legal, political, and engineering contributions. Key periods include the Roman Kingdom, Republic, and Empire, each characterized by different governance structures and cultural achievements.
  - **Political Structures**: Transition from monarchy to republic to empire, with institutions like the Senate influencing modern governance.
  - **Culture and Society**: Hierarchical society with significant public amenities and a shift from polytheism to Christianity. Architectural advancements included the use of concrete, arches, and domes.
  - **Military Innovations**: Professional standing army and advanced engineering in siege warfare.

- **Persian Empire**: Known for its extensive territory, sophisticated administration, and cultural achievements. Key periods include the Achaemenid, Parthian, and Sassanian Empires.
  - **Political Structures**: Centralized administration with satrapies and a standardized bureaucratic system.
  - **Culture and Society**: Zoroastrianism as the state religion, influencing later faiths. Notable art and architecture, and a diverse economy facilitated by extensive trade networks.
  - **Military Innovations**: Use of cavalry and archers, with elite units like the Immortals.

The achievements and legacy of Classical Antiquity have profoundly influenced Western civilization, shaping modern governance, philosophy, art, and science.
</digest>
<last_heading>
last contents item: `Persian Empire`
text:
The Persian Empire, one of the largest and most influential empires in ancient history, is renowned for its vast territorial expanse, sophisticated administrative system, and cultural achievements. Spanning from the 6th century BCE to the 7th century CE, the Persian Empire played a crucial role in shaping the political, cultural, and economic landscape of the ancient world.
...
2.High Middle Ages: [The High Middle Ages, spanning roughly from the 11th to the 13th centuries, was a period of significant growth and transformation in Europe. This era saw the consolidation of feudalism, the expansion of trade and urban centers, and significant cultural and intellectual achievements.
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Middle Ages`.
A: 

-------------------- write_mutation for 'Renaissance and Reformation' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Renaissance and Reformation` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
**Middle Ages**: Spanning from the 5th to the early 16th centuries, the Middle Ages is a multifaceted period in European history, divided into three phases: Early, High, and Late Middle Ages, each marked by distinct political, social, economic, and cultural developments.

- **Early Middle Ages (5th to 10th Century)**: Known as the "Dark Ages," this phase followed the collapse of the Western Roman Empire, leading to the formation of new kingdoms and the spread of Christianity.
  - **Geopolitical Landscape**: Various barbarian kingdoms emerged, such as the Franks and Lombards, while the Byzantine Empire continued to thrive.
  - **Culture and Religion**: The spread of Christianity and the rise of monasticism were significant, with monasteries preserving knowledge and culture.
  - **Society and Economy**: The beginnings of the feudal system emerged, characterized by a hierarchy of lords and vassals.
  - **Notable Events and Figures**: Charlemagne's reign marked the Carolingian Renaissance, and Viking invasions impacted European societies.
  - **Intellectual and Artistic Developments**: Preservation of classical texts and the development of Romanesque architecture.

- **High Middle Ages (11th to 13th Century)**: A period of growth and transformation, marked by the consolidation of feudal monarchies, expansion of trade, and cultural achievements.
  - **Geopolitical Landscape**: Centralized governance under dynasties like the Capetians in France and the Plantagenets in England.
  - **Culture and Religion**: The rise of scholasticism, establishment of universities, and Gothic architecture.
  - **Society and Economy**: The feudal system reached its zenith, and agricultural innovations increased productivity.
  - **Notable Events and Figures**
</digest>
<last_heading>
last contents item: `Late Middle Ages`
text:
...
<dep_text>
1.Renaissance: [The **Renaissance** was a transformative period in European history, spanning roughly from the 14th to the 17th centuries. It marked a profound cultural rebirth following the Middle Ages, characterized by a resurgence of interest in the classical art, literature, and learning of Ancient Greece and Rome. This era saw unprecedented advancements in various fields, including art, science, politics, and philosophy.
...
2.Reformation: [The **Reformation** was a pivotal movement in European history, spanning from the early 16th century to the mid-17th century. It marked a significant shift in the religious, political, and cultural landscape of Europe, leading to the fragmentation of the Roman Catholic Church and the rise of Protestantism.
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Renaissance and Reformation`.
A: 

-------------------- write_mutation for 'Modern Era' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Modern Era` for the title <The Comprehensive Guide to World History>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `Scientific Revolution`
text:
The **Scientific Revolution** was a transformative period in European history, spanning the 16th and 17th centuries, marked by significant advancements in scientific thought and methodology. This era laid the groundwork for modern science and drastically altered humanity's understanding of the natural world.
...
3.Cold War and Beyond: [**Cold War and Beyond**
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Modern Era`.
A: 
