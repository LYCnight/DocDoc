...
-------------------- write_with_dep for 'Journey to the Moon' --------------------
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `First Contact`.
A: 
...
-------------------- write_with_dep for 'The Alien Threat' --------------------
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `The Alien Threat`.
A: 
...
<rule>
You are writing the body content of the table of contents item `Escape Plan` for the title <The Dark Side of the Moon>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<last_heading>
last contents item: `The Alien Threat`
text:
**The Alien Threat**
...
<dep_text>
1.The Alien Threat: [**The Alien Threat**
...
<rule>
You are writing the body content of the table of contents item `Betrayal` for the title <The Dark Side of the Moon>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
-------------------- write_with_dep for 'Final Confrontation' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Final Confrontation` for the title <The Dark Side of the Moon>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Final Confrontation`.
A: 

-------------------- write_with_dep for 'Return to Earth' --------------------

<role>
You are a writing expert.
</role>
<rule>
You are writing the body content of the table of contents item `Return to Earth` for the title <The Dark Side of the Moon>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
The revelation of Dr. Reed's betrayal left the Lunar Dawn mission team grappling with a profound sense of unease. Trust had been fractured, and
</digest>
<last_heading>
last contents item: `Final Confrontation`
text:
**Final Confrontation**
...
<dep_text>
1.Final Confrontation: [**Final Confrontation**
...
<task>
Q: Based on the content, digest, last_heading, dep_text, and retrieved_knowledge, generate the body content for the table of contents item `Return to Earth`.
A: 
...
<rule>
You are writing the body content of the table of contents item `Epilogue` for the title <The Dark Side of the Moon>.
constraints: These are the constraints that must be followed.
content: This is the table of contents of the article.
digest: This is a summary of what you have written so far.
last_heading: This is the content of the last item in the table of contents that you wrote. You need to learn from it and maintain a consistent writing style.
...
The final confrontation with the alien sentinel had left the Lunar Dawn team both triumphant and weary. The discovery of the alien civilization's data archives and the
</digest>
<last_heading>
last contents item: `Return to Earth`
text:
**Return to Earth**
...
<dep_text>
1.Return to Earth: [**Return to Earth**
